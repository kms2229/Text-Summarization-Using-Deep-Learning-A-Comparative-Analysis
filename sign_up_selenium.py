...
class ChromeSearch(unittest.TestCase):
    def test_sign_up_working(self):
        ...
        driver.get("https://bu-marketplace.herokuapp.com/sign_up")
...
# click signup button
        ...
        #button.click()
        driver.find_element_by_xpath("/html/body/div/div[1]/form/button").click()
        sleep(5)    
        s=driver.current_url
        try:
            k=driver.find_element_by_xpath("/html/body/div[1]/button/span")
            s="done"
        except:
            if k==s:
